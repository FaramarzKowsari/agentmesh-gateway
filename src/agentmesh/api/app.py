    ...
    async def provider_states() -> dict[str, object]:
        ...
        for spec in settings.providers:
            ...
            result[spec.name] = {
                ...
                "latency_window_size": state.latency_window_size,
                "input_tokens_total": state.input_tokens_total,
                "output_tokens_total": state.output_tokens_total,
                "token_usage_observations": state.token_usage_observations,
                "cost_total_usd": state.cost_total_usd,
                "cost_observations": state.cost_observations,
